...
public class CustomDialog extends Dialog {
	 ...
	 * @param listener
	 */
	public void setConfirmBtnIsCloseWindow(View.OnClickListener listener){
		try {
	 ...
	 * @param listener
	 */
	public void setConfirmBtnClickListener(View.OnClickListener listener,String text){
		try {
			if(!"".equals(text)){
	 ...
	 * @param listener
	 */
	public void setCancelBtnClickListener(View.OnClickListener listener,String text){
		try {
			if(!"".equals(text)){
