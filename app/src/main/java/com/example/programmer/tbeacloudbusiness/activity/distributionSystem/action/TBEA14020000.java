...
public class TBEA14020000 {
    public static final String SERVICE_CODE = "TBEA14020000";
    ...
    public ArrayList<ComplainItem> ComplainList = new ArrayList<ComplainItem>();
    ...
    public TBEA14020000(AsyncListener asynListener) {
    ...
    class MeAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                if (JsonUtil.hasArray(jobj, "ComplainList")) {
                    JSONArray jarray = jobj.getJSONArray("ComplainList");
                    for (int i = 0; i < jarray.length(); i++) {
                        ComplainList.add(ComplainItem.initByJson(jarray.getJSONObject(i)));
                    }
                }
            } catch (Exception e) {
                hasError = true;
