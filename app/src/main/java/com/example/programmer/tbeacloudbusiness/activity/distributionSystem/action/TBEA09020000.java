...
public class TBEA09020000 {
    public static final String SERVICE_CODE = "TBEA09020000";
    ...
    public ArrayList<ReferencePriceItem> ReferencePriceList = new ArrayList<ReferencePriceItem>();
    ...
    public TBEA09020000(AsyncListener asynListener) {
    ...
    class MeAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            pairs.add(new BasicNameValuePair("CommodityName", CommodityName));
            ...
            try {
                ...
                if (JsonUtil.hasArray(jobj, "ReferencePriceList")) {
                    JSONArray jarray = jobj.getJSONArray("ReferencePriceList");
                    for (int i = 0; i < jarray.length(); i++) {
                        ReferencePriceList.add(ReferencePriceItem.initByJson(jarray.getJSONObject(i)));
                    }
                }
            } catch (Exception e) {
                hasError = true;
