...
public class TBEA07030600 {
    public static final String SERVICE_CODE = "TBEA07030600";
    ...
    public TBEA07030600(AsyncListener asynListener) {
    ...
    class MeAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            pairs.add(new BasicNameValuePair("Count", String.valueOf(Count)));
            pairs.add(new BasicNameValuePair("FloatRatio", String.valueOf(FloatRatio)));
            pairs.add(new BasicNameValuePair("Price", String.valueOf(Price)));
            pairs.add(new BasicNameValuePair("Note", String.valueOf(Note)));
