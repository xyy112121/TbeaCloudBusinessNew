...
public class TBEA11010000 {
	public static final String SERVICE_CODE = "TBEA11010000";
	...
	public ArrayList<AnnouncementListItem> AnnouncementList=new ArrayList<AnnouncementListItem>();
	...
	public TBEA11010000(AsyncListener asynListener) {
	...
	class MeAsyncTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			pairs.add(new BasicNameValuePair("Name", String.valueOf(Name)));
			...
			try {
				...
				if(JsonUtil.hasArray(jobj,"AnnouncementList")){
					JSONArray jarray=jobj.getJSONArray("AnnouncementList");
					for(int i=0;i<jarray.length();i++){
						AnnouncementList.add(AnnouncementListItem.initByJson(jarray.getJSONObject(i)));
					}
				}
			} catch (Exception e) {
				hasError = true;
