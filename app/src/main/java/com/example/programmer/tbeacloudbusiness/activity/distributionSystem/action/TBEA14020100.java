...
import com.example.programmer.tbeacloudbusiness.activity.distributionSystem.model.ComplainInfo;
...
public class TBEA14020100 {
    public static final String SERVICE_CODE = "TBEA14020100";
    ...
    public TBEA14020100(AsyncListener asynListener) {
    ...
    class MeAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                complainInfo = ComplainInfo.initByJson(jobj.getJSONObject("ComplainInfo"));
            } catch (Exception e) {
                hasError = true;
