...
public class MarketInfoBeSoldActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        case ThreadState.SUCCESS:
                            SaleListResponseModel model = (SaleListResponseModel) msg.obj;
                            if (model.isSuccess() && model.data != null) {

                                if (model.data.commodityinfo != null) {
                                    SaleListResponseModel.DataBean.CommodityinfoBean obj = model.data.commodityinfo;
    ...
    class MyAdapter extends ArrayAdapter<SaleListResponseModel.DataBean.SalelistBean> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            SaleListResponseModel.DataBean.SalelistBean obj = getItem(i);
