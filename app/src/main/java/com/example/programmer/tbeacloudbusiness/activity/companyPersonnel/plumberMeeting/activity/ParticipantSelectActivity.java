...
public class ParticipantSelectActivity extends BaseActivity implements View.OnClickListener {
    ...
    List<ParticipantSelectlListResponseModel.DataBean.CompanyemployeelistBean> mSelectList = new ArrayList<>();
                ...
                public void run() {
                    try {
                        ...
                        if (mFlag) {
                            ...
                            model = action.getParticipantList();
                        }
    ...
    public class MyAdapter extends ArrayAdapter<ParticipantSelectlListResponseModel.DataBean.CompanyemployeelistBean> {
        int resourceId;
        ...
        // 初始化isSelected的数据
        public void initDate(int count, List<ParticipantSelectlListResponseModel.DataBean.CompanyemployeelistBean> list) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final ParticipantSelectlListResponseModel.DataBean.CompanyemployeelistBean obj = getItem(position);
