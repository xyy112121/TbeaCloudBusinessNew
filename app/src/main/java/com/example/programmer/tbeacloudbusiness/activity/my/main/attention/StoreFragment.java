...
public class StoreFragment extends Fragment implements BGARefreshLayout.BGARefreshLayoutDelegate {
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        case ThreadState.SUCCESS:
                            AttentionStoreResponseModel model = (AttentionStoreResponseModel) msg.obj;
                            if (model.isSuccess()) {
            ...
            if (mAdapter != null) {
                ...
                ((MyAttentionActivity) getActivity()).mSelectAllLayout.findViewById(R.id.my_attention_cancel).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        String ids = "";
                        if (mAdapter != null) {
                            for (AttentionStoreResponseModel.DataBean.MyfocuslistBean item : mAdapter.mList) {
    ...
    class MyAdapter extends BaseAdapter {
        ...
        private List<AttentionStoreResponseModel.DataBean.MyfocuslistBean> mList = new ArrayList<>();
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            AttentionStoreResponseModel.DataBean.MyfocuslistBean obj = mList.get(position);
            ImageLoader.getInstance().displayImage(MyApplication.instance.getImgPath() + obj.thumbpicture, holder.mHeadView);
            ImageLoader.getInstance().displayImage(MyApplication.instance.getImgPath() + obj.usertypeicon, holder.mPersontypeiconView);
            holder.mNameView.setText(obj.name);
            holder.mJobtitleView.setText(obj.fansnumber);
            return convertView;
        }
        ...
        public void addAll(List<AttentionStoreResponseModel.DataBean.MyfocuslistBean> list) {
            mList.addAll(list);
            notifyDataSetChanged();
        }
