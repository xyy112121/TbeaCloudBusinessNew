...
public class TBEA14010000 {
    public static final String SERVICE_CODE = "TBEA14010000";
    ...
    public TBEA14010000(AsyncListener asynListener) {
    ...
    class MeAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            pairs.add(new BasicNameValuePair("Content", String.valueOf(Content)));
            pairs.add(new BasicNameValuePair("MobileNumber", String.valueOf(MobileNumber)));
